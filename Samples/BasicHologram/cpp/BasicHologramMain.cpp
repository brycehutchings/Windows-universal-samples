...
BasicHologramMain::BasicHologramMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded +=
        ref new EventHandler<Gamepad^>(
            bind(&BasicHologramMain::OnGamepadAdded, this, _1, _2)
            );

    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved +=
        ref new EventHandler<Gamepad^>(
            bind(&BasicHologramMain::OnGamepadRemoved, this, _1, _2)
            );
...
void BasicHologramMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged +=
            ref new EventHandler<Object^>(
                bind(&BasicHologramMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2)
                );
    }
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&BasicHologramMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&BasicHologramMain::OnCameraRemoved, this, _1, _2)
                );
...
bool BasicHologramMain::Render(HolographicFrame^ holographicFrame)
{
...
void BasicHologramMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
...
void BasicHologramMain::OnGamepadAdded(Object^, Gamepad^ args)
{
...
void BasicHologramMain::OnGamepadRemoved(Object^, Gamepad^ args)
{
...
void BasicHologramMain::OnHolographicDisplayIsAvailableChanged(Object^, Object^)
{
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken =
                ...
                ref new TypedEventHandler<SpatialLocator^, Object^>(
                    std::bind(&BasicHologramMain::OnLocatabilityChanged, this, _1, _2)
                    );
